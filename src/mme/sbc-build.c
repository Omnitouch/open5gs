...
ogs_pkbuf_t *sbc_build_write_replace_warning_response(ogs_sbc_message_t *request)
{
    ...
    sbc_write_replace_warning_t *write_replace_warning_response =
        &response.choice.successfulOutcome.choice.write_replace_warning;
    
    sbc_write_replace_warning_t *write_replace_warning_request =
        &request->choice.initiatingMessage.choice.write_replace_warning;
